...
const slotController = require('../slots/slot.controller');
...
const { createFieldSchema, updateFieldSchema } = require('../fields/field.validator');
const { batchCreateSlotsSchema, updateSlotSchema } = require('../slots/slot.validator');
